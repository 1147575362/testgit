...
//  static lin_wakeup_cb_func_send_t lin_wakeup_callbak_send = NULL;
#endif
...
/*
LIN_Device_Frame_t linm_cmd;
 void wakeupSendCallback(void)
{
    LINM_SendFrame(&linm_cmd);
}
*/
//void LINS_RegisterLINStack_IRQ(lin_stack_cb_func_t callback, lin_wakeup_cb_func_t wakeupCallback, lin_wakeup_cb_func_send_t wakeupSendCallback) 
void LINS_RegisterLINStack_IRQ(lin_stack_cb_func_t callback, lin_wakeup_cb_func_t wakeupCallback)
{
 ...
 //   lin_wakeup_callbak_send = wakeupSendCallback;
...
void WULIN_Handler(void)
{
    if (WICA_REG_STATUS.LINS != 0U){
        ...
        /*    if (lin_wakeup_callbak_send != NULL)
            {
                lin_wakeup_callbak_send();
            }
         */
        WICA_REG_CTRL.LINSIRQCLR = 1U;
    }
