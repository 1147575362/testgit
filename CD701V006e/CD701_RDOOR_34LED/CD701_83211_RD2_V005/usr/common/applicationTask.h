...
// modify 2023.12.25
#ifdef SideLeft
    #define INIT_LINS_NAD_ADDR              (0x0DU)         // RRD2:0x0F    RLD2:0x0D
#else
    #define INIT_LINS_NAD_ADDR              (0x0FU)  
#endif
...
#define SLAVEADDRESS    (2)			//固定2号，1号通过主机控制

#if SLAVEADDRESS==1
#define SlaveLEDNum		(16)		
#endif
#if SLAVEADDRESS==2
#define SlaveLEDNum		(18)		
#endif
