...
/*  **********************fix LIN configuration default value ************************************/
		...
		systemParam.info.linParams.fid          = INIT_LINS_FID_ADDR;
        ...
        systemParam.info.linParams.light_max_lv = INIT_LIGHT_MAX_LV;
...
uint8_t GetFID()
{
    return systemParam.info.linParams.fid;
}

uint8_t GetNAD()
{
    return systemParam.info.linParams.nad;
}

uint8_t Getlight_max_lv()
{
    return systemParam.info.linParams.light_max_lv;
}

void ASSIGN_INFO(uint8_t FID, uint8_t Light)
{
    if(FID ==0x25 || FID ==0x35)
    {
        systemParam.info.linParams.fid = 0x05;
    }
    else if(FID ==0x26)
    {
        systemParam.info.linParams.fid = 0x16;
    }
    else
    {
        systemParam.info.linParams.fid = FID;
    }
    systemParam.info.linParams.nad = FID;
	systemParam.info.linParams.light_max_lv = Light;
