...
typedef union{
  struct {
    ...
    uint8_t                           :  1; /* (reserved) */
    uint8_t  DISAUTOSLEEP             :  1; /* ONly for C1 and later, Disable Auto Sleep. Set to Disable auto sleep. */
 ...
 */
#define LINM_REG_DATA(index)            (*(__IO        uint8_t *)(0x50010800 + index *4U))
#define LINM_REG_CTRL                   (*(__IO    LINM_CTRL_t *)(0x50010820))
#define LINM_REG_STATUS                 (*(__IO  LINM_STATUS_t *)(0x50010824))
#define LINM_REG_ERROR                  (*(__IO   LINM_ERROR_t *)(0x50010828))
#define LINM_REG_DL                     (*(__IO      LINM_DL_t *)(0x5001082C))
#define LINM_REG_BTDIV07                (*(__IO        uint8_t *)(0x50010830))
#define LINM_REG_BITTIME                (*(__IO LINM_BITTIME_t *)(0x50010834))
#define LINM_REG_ID                     (*(__IO        uint8_t *)(0x50010838))
#define LINM_REG_BUSTIME                (*(__IO LINM_BUSTIME_t *)(0x5001083C))
#define LINM_REG_TX_STATUS            (*(__IO LINM_TX_STATUS_t *)(0x50010840))
#define LINM_REG_WUPDETECTTHRES       (*(__IO          uint8_t *)(0x50010844))
