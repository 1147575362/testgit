...
typedef struct {
  ...
  uint8_t  TRIM_LF_RC;                        /*<! 16KHz RC oscillator trim +0x01C */
...
#define SYSCTRLA_REG_RETAIN0                            (*(__IO                     uint8_t *)(0x50012000))/*  please don't use for it's reserved for system use   */
...
#define SYSCTRLA_REG_PMU_TRIM                           (*(__IO         SYSCTRLA_PMU_TRIM_t *)(0x50012018))
#define SYSCTRLA_REG_TRIM_LF_RC                         (*(__IO                     uint8_t *)(0x5001201C))
#define SYSCTRLA_REG_HF_OSC_TRIM                        (*(__IO                     uint8_t *)(0x50012020))
#define SYSCTRLA_REG_BIAS                               (*(__IO             SYSCTRLA_BIAS_t *)(0x50012024))
#define SYSCTRLA_REG_TRIM_LED(x)                        (*(__IO          SYSCTRLA_TRIMLED_t *)(0x50012028 + x*4U))
#define SYSCTRLA_REG_TRIMVFW                            (*(__IO                     uint8_t *)(0x50012034))
#define SYSCTRLA_REG_LIN                                (*(__IO              SYSCTRLA_LIN_t *)(0x50012038))
#define SYSCTRLA_REG_DFTCODE                            (*(__IO          SYSCTRLA_DFTCODE_t *)(0x5001203C))
#define SYSCTRLA_REG_DFT_ACCESS_ENABLED                 (*(__IO                     uint8_t *)(0x50012040))
#define SYSCTRLA_REG_DFTTESTMODESTART                   (*(__IO                     uint8_t *)(0x50012044))
#define SYSCTRLA_REG_NAME                               (*(__IO                    uint32_t *)(0x50012048))
#define SYSCTRLA_REG_REV                                (*(__IO                    uint16_t *)(0x5001204C))
#define SYSCTRLA_REG_ENABORTESTMODE                     (*(__IO                     uint8_t *)(0x50012050))
