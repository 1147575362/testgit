...
typedef union {
  struct {
    ...
    uint8_t  CH4SEL                   :  3; /*!< Channel4 Selection */
    uint8_t                           :  3; /*   (reserved) */
  };
  uint32_t WORD;
}ADC_CNTRL_t;
...
#define ADC_REG_CONF            (*(__IO   ADC_CONF_t *)(0x50010D00))
#define ADC_REG_CNTRL           (*(__IO  ADC_CNTRL_t *)(0x50010D04))
#define ADC_REG_TSET            (*(__IO   ADC_TSET_t *)(0x50010D08))
#define ADC_REG_DATA1           (*(__IO     uint16_t *)(0x50010D0C))
#define ADC_REG_DATA2           (*(__IO     uint16_t *)(0x50010D10))
#define ADC_REG_DATA0345        (*(__IO     uint16_t *)(0x50010D14))
#define ADC_REG_STATUS          (*(__IO ADC_STATUS_t *)(0x50010D18))
