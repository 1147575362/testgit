...
/*
 *  Set xy absolute physical intensity output  for example: P(x,y) = (0.33333,0.33333) x = 0.33333*65536 = 21845, y = 0.33333*65536 = 21845  intensity: lumen or mcd
...
/*
 *  Set uv absolute phy intensity output,intensity: lumen or mcd
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] u: 0-1023
 *  @param [in] v: 0-1023
 *  @param [in] intensity: 0-65535, lumen or mcd, if intensity value is higher than maximum intensity of the target color, it would display maximum intensity of the target color.
 ...
 *  @return 0
 */
uint8_t CLM_SetAbsLUV(LedNum_t ledIndex,ColorTemperature_t temperature, uint16_t u, uint16_t v, uint16_t intensity, uint16_t transitionTime);
